...
global.require = function require(...args) {
...
module.exports = (env, args) => {
    ...
    // not a pretty solution but for the sake of time,
    // lets us inspects arguments in other marged configs
    ...
    if(mode && fs.existsSync(modeConfigPath)) {
        return merge(baseConfig, require(modeConfigPath));
    }
