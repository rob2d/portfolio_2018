export default {
    ...
    shortDescription: 'A simple and efficient React hook for measuring the window\'s size',
    description: [
        'A simple and efficient React hook for measuring the window\'s ' +
        'size with support for serverside rendering and debouncing. ' +
    ...
    links: [
        ...
        {
            url: 'https://preview.npmjs.com/package/use-viewport-sizes',
            description: 'NPM repository/Readme'
        }
    ]
};
