const projects = [{
    ...
    points: [
        ...
        'make selections in realtime. Features include a dynamically updating panel that shows textures ' +
        'selected in any given object by a user. Written between most recent position and now to demonstrate ' +
        'technical proficiency in writing performant/scalable applications in modern React paradigms as well as ' +
        'being capable/willing to learn other new concepts quickly.'
    ]
}, {
    ...
    points: [
        ...
        'game/consumer electronics firmware. ',

        'This was purely volunteer to start, and work involved included reverse engineering Android packages, then fully ' +
        'rewriting a targeted set of quality of life improvements and CPU optimizations. These were accompanied by dynamic ' +
        'interfaces using React Native builds that were designed to work seamlessly for testing sessions. this with application ' +
